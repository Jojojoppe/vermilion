...
Vermilion::Core::Vulkan::VertexBuffer::VertexBuffer(Vermilion::Core::Vulkan::API* api, std::vector<float>& vertices, Vermilion::Core::BufferType type){
	this->api = api;
...
Vermilion::Core::Vulkan::IndexBuffer::IndexBuffer(Vermilion::Core::Vulkan::API* api, std::vector<unsigned int>& indices, Vermilion::Core::BufferType type){
	this->api = api;
	this->instance = api->instance;
	this->element_size = sizeof(unsigned int);
