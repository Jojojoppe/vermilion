...
Vermilion::Core::Vulkan::Texture::Texture(Vermilion::Core::Vulkan::API * api, size_t width, size_t height, unsigned int channels){
    this->api = api;
...
void Vermilion::Core::Vulkan::Texture::setData(void * data, size_t size){
